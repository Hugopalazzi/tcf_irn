...
<div class = "page-container">
	<div class ="left-size">
		<img class="logo" src="/assets/images/logo_my_story.png" alt="PCF IRN" />
		<img class="logo" src="/assets/images/tcf_background_no_bg.png" alt="PCF IRN" />
	</div>
...
.page-container{
	...
	.background-image {
		// background-image: url('/assets/images/tcf_background_no_bg.png');
		// opacity: 0.5;
